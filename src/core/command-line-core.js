...
export function commandBarShouldCapture({ key, ctrlKey, metaKey, altKey, typingInFormField, dialogOpen, enabled, keyReserved = () => false }) {
...
export function spaceRepeatAction({ query, lastTool, toolArmed }) {
