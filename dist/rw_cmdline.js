...
function commandBarShouldCapture({ key, ctrlKey, metaKey, altKey, typingInFormField, dialogOpen, enabled, keyReserved = () => false }) {
...
function spaceRepeatAction({ query, lastTool, toolArmed }) {
