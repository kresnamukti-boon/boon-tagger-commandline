// ===== src/core/autoselect-core.js =====
const __m_autoselect_core = (function(){
...
function breakerStep(log, now, { max, windowMs }) {
...
function goSelectDecision({ now, lastSelectAt, bypassSuppression, suppressMs, atRest }) {
...
function watchEdge({ cur, prev, nullPending }) {
...
function watchShouldFire({ now, lastUserCmdAt, userGraceMs, inputHasText, mode, drawMode, modeActive }) {
...
return {breakerStep, goSelectDecision, watchEdge, watchShouldFire};
})();
